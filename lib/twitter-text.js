var TwitterText = (function () { 
    ...
    regexes['extract_mentions'] = new RegExp("(^|[^a-zA-Z0-9_])" + regexes['at_signs'].source + "([a-zA-Z0-9_]{1,20})(?=(.|$))", "og");
    regexes['extract_reply'] = new RegExp("^(?:" + regexes['spaces'].source + ")*" + regexes['at_signs'].source + "([a-zA-Z0-9_]{1,20})", "og");
